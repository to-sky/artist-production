...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="{{ route(config('admin.route').'.clients.index') }}"><i class="fa fa-angle-double-left"></i> Back to all <span>{{ $menu->plural_name }}</span></a><br><br>
    ...
    {!! Form::text('comission', old('$comission'), array('class'=>'form-control')) !!}
