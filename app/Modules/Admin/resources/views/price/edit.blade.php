...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            {!! Form::model($price, array('method' => 'PATCH', 'route' => array(config('admin.route').'.prices.update', $price->id))) !!}
    ...
    {!! Form::text('price$', old('price',$price->price), array('class'=>'form-control')) !!}
