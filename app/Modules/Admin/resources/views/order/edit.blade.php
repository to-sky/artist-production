...
@section('content')
    ...
    {!! Form::text('subtotal', old('subtotal',$order->subtotal), array('class'=>'form-control')) !!}
    
</div><div class="form-group col-md-12">
    {!! Form::label('$comment', 'Comment') !!}
    {!! Form::textarea('comment', old('comment',$order->comment), array('class'=>'form-control ckeditor')) !!}
    ...
    {!! Form::textarea('shipping_comment', old('shipping_comment',$order->shipping_comment), array('class'=>'form-control ckeditor')) !!}
    
</div><div class="form-group col-md-12">
    {!! Form::label('shipping_price', 'Shipping price') !!}
    {!! Form::text('shipping_price', old('shipping_price',$order->shipping_price), array('class'=>'form-control')) !!}
    
</div><div class="form-group col-md-12">
    {!! Form::label('paid_at', 'Paid at') !!}
    {!! Form::text('$paid_at', old('paid_at',$order->paid_at), array('class'=>'form-control datetimepicker')) !!}
