<html>
    <head>
        ...
        <style>
            ...
            @font-face {
                ...
                src:
                    url('{{ storage_path('fonts/ProximaNova-Regular.eot') }}') format('eot'),
                    url('{{ storage_path('fonts/ProximaNova-Regular.ttf') }}') format('truetype'),
                    url('{{ storage_path('fonts/ProximaNova-Regular.woff') }}') format('woff');
            }

            @font-face {
                font-family: ProximaNovaSB;
                src:
                    url('{{ storage_path('fonts/ProximaNova-Semibold.eot') }}') format('eot'),
                    url('{{ storage_path('fonts/ProximaNova-Semibold.ttf') }}') format('truetype'),
                    url('{{ storage_path('fonts/ProximaNova-Semibold.woff') }}') format('woff');
                font-weight: 700;
            }
    ...
    <body>
        <table width="100%" cellpadding="0" cellspacing="0" style="height: 893px"><tr><td valign="top">
                    <table width="100%">
                        <tr>
                            <td align="right">
                                <img width="50" height="50" src="{{ public_path('/images/logo.png') }}" alt="{{ config('app.name') }}">
                            </td>
                        </tr>
                    </table>
                    ...
                    <span style="font-size: 26px; font-family: ProximaNovaSB; line-height: .8em">Rechnung</span>
                    <table border="1" bordercolor="black" bordercolorlight="white" bordercolordark="white" cellspacing="0" cellpadding="2" style="width: 100%; font-size: 12px; font-family: ProximaNovaSB; line-height: .7">
                        <tr align="center">
