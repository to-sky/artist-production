...
@section('content')
    ...
    <!-- Address -->
    {!! Form::open(array('route' => ['address.update', 'address' => $address])) !!}
        <section class="ap_section">
            <div class="ap_section__heading">
                <h2 class="ap_section__title">{!! __('Edit address') !!}</h2>
            </div>
            <div class="ap_section__content">
                <div class="ap_form">
                    <div class="ap_form__group">
                        {!! Form::label(null, __('First name'), array('class'=>'ap_form__label')) !!}
                        {!! Form::text('address[first_name]', old('address[first_name]', $address->first_name), array('class'=>'ap_form__input')) !!}
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::text('address[last_name]', old('address[last_name]', $address->last_name), array('class'=>'ap_form__input')) !!}
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::select('address[country_id]', $countries, old('address[country_id]', $address->country_id), array(
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::text('address[city]', old('address[city]', $address->city), array('class'=>'ap_form__input')) !!}
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::text('address[post_code]', old('address[post_code]', $address->post_code), array('class'=>'ap_form__input')) !!}
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::text('address[street]', old('address[street]', $address->street), array('class'=>'ap_form__input')) !!}
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::text('address[house]', old('address[house]', $address->house), array('class'=>'ap_form__input')) !!}
                    ...
                    <div class="ap_form__group">
                        ...
                        {!! Form::text('address[apartment]', old('address[apartment]', $address->apartment), array('class'=>'ap_form__input')) !!}
